# Generated by Django 4.0.1 on 2022-01-11 13:46
...
# 관리자 1명 생성 및 유저 3명 생성
def gen_master(apps, schema_editor):
    User.objects.create_user(username="admin@admin.com", password="admin", first_name="관리자", email="admin@admin.com", gender=User.GenderChoices.MALE,
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, default='', max_length=30, verbose_name='이름')),
